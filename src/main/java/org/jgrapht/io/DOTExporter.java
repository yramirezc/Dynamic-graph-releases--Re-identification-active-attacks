    ...
    GraphExporter<V, E>
{
    ...
    public void exportGraph(Graph<V, E> g, Writer writer)
    {
       ...
       // out.println(computeHeader(g));
        ...
        // vertex set
		/*
		 * for (V v : g.vertexSet()) { out.print(INDENT); out.print(getVertexID(v));
		 * 
		 * String labelName = null; if (vertexLabelProvider != null) { labelName =
		 * vertexLabelProvider.getName(v); } Map<String, Attribute> attributes = null;
		 * if (vertexAttributeProvider != null) { attributes =
		 * vertexAttributeProvider.getComponentAttributes(v); } renderAttributes(out,
