...
public class GraphUtil {
	...
	public static UndirectedGraph<String, DefaultEdge>  transformIntoJGraphT(int[][] matrix) {
		UndirectedGraph<String, DefaultEdge> result = (UndirectedGraph<String, DefaultEdge>) new SimpleGraph<String, DefaultEdge>(DefaultEdge.class);
	...
	public static int[][] getRandomGraph(int vexnum, int edgenum, boolean b) {
		...
		return transformIntoAdjacencyMatrix((UndirectedGraph<String, DefaultEdge>) graph);
	}
	...
	public static UndirectedGraph<String, DefaultEdge> shiftAndShuffleVertexIds(UndirectedGraph<String, DefaultEdge> originalGraph, int offset, Set<String> verticesToKeep) {
		...
		UndirectedGraph<String, DefaultEdge> newGraph = (UndirectedGraph<String, DefaultEdge>) new SimpleGraph<String, DefaultEdge>(DefaultEdge.class);
	...
	public static UndirectedGraph<String, DefaultEdge> loadSNAPFormat(String readerName) {
		try {
			UndirectedGraph<String, DefaultEdge> graph = (UndirectedGraph<String, DefaultEdge>) new SimpleGraph(DefaultEdge.class);
			...
			return (UndirectedGraph<String, DefaultEdge>) new SimpleGraph(DefaultEdge.class);
		}
	}
	...
	public static UndirectedGraph<String, DefaultEdge> inducedSubgraph(UndirectedGraph<String, DefaultEdge> graph, Set<String> subset) {
		UndirectedGraph<String, DefaultEdge> subgraph = (UndirectedGraph<String, DefaultEdge>) new SimpleGraph(DefaultEdge.class);
		for (String v : subset)
	...
	public static Set<String> greedyMaxIndependentSet(UndirectedGraph<String, DefaultEdge> graph, boolean workOnCopyOfGraph) {
		if (workOnCopyOfGraph)
			return greedyMaxIndependentSet((UndirectedGraph<String, DefaultEdge>) cloneGraph(graph));
		else 
